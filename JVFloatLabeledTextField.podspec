Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/fantasticatif/JVFloatLabeledTextField"
  ...
  s.author       = { "Jared Verdi" => "jared@jaredverdi.com", "fantasticatif" => "4taras4@gmail.com" }
  s.source       = { :git => "https://github.com/fantasticatif/JVFloatLabeledTextField.git", :tag => s.version.to_s }
  s.platform     = :ios, '9.0'
